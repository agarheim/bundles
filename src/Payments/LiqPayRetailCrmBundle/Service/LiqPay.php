...
use App\Payments\LiqPayRetailCrmBundle\Service\Logger;
...
class LiqPay
{
    ...
    public function setAuth($public_key, $private_key, $api_url = null)
    {
        if (empty($public_key)) {
     ...
     * @return stdClass
     */
    public function api(string $path, $params = array(), $timeout = 5)
    {
     ...
     * @return string
     */
    public function cnb_signature(array $params)
    {
        $params      = $this->cnb_params($params);
        $private_key = $this->_private_key;
